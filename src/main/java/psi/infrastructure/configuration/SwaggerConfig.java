...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo(
                "Study Plan Management System Api",
                "Api documentation for Study Plan Management System",
                "1.0",
                "TERMS OF SERVICE URL",
                new Contact("Admin", "www.study-plans-management-system.support.com", "admin@example.com"),
                "Apache 2.0",
